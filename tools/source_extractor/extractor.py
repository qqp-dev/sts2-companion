...
def build_artifact(verified: VerifiedInputs) -> bytes:
    ...
    artifact: dict[str, Any] = {
        ...
        "coverage": {
            ...
            "productionProducerSemantics": complete(production["productionSemantics"]["sourceDenominators"]["producers"], 7),
            "productionPoolSemantics": complete(production["productionSemantics"]["sourceDenominators"]["pools"], 7),
            "productionCandidateEntries": complete(production["productionSemantics"]["sourceDenominators"]["candidateEntries"], 9),
            "productionSlotPolicies": complete(production["productionSemantics"]["sourceDenominators"]["slotStrategies"], 6),
            "productionCandidateRngSelection": complete(production["productionSemantics"]["sourceDenominators"]["candidateRngSelections"], 1),
            "productionPostAddEffects": complete(production["productionSemantics"]["sourceDenominators"]["postAddEffects"], 4),
            "productionRuntimeStateContracts": complete(production["productionSemantics"]["sourceDenominators"]["runtimeStateContracts"], 12),
            "productionDependencyRefs": complete(production["productionSemantics"]["sourceDenominators"]["dependencyRefs"], 4),
