...
.roster-capsule{display:grid;gap:.18rem;margin:.72rem 0 .1rem;padding:.4rem 0;border-top:1px solid var(--qq-line);overflow-wrap:anywhere}.capsule-label{color:var(--qq-muted);font-size:.68rem;font-weight:700;letter-spacing:.06em;text-transform:uppercase}.roster-line{font-size:.9rem;font-weight:650}.primary-roster{padding:.62rem .05rem}.primary-roster .roster-line{margin:.22rem 0;font-size:.84rem;font-weight:520;line-height:1.42}.primary-roster .boundary-note{margin:.25rem 0 0;line-height:1.38}.roster-capsule .boundary-note{padding:0;border:0}
