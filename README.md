...
[`docs/decision-projection.md`](docs/decision-projection.md). Its human unit is an
ordered, typed effect signature rather than an enemy move name; for
multi-enemy states it defines a conditional, horizon-qualified counterfactual
removal frontier instead of a static target priority. It preserves the E1/E2/C1
gates and does not describe current runtime output.
