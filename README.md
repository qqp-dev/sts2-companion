...
`tools/extract-source.py`. Schema 13 remains deliberately
`status: "incomplete"` and `runtimeReady: false`: Waves A, B, E1, E2a, E2b, E2c1,
E2c2a, E2c2b, E2d1a, E2d1b, and E2d2a core lifecycle families are complete only for their declared source denominators. Runtime cutover remains gated inside the staged Wave C.
...
remain unchanged through E2d2a.
